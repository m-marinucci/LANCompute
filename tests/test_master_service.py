...
class TestTask:
    ...
    def test_task_creation(self):
        ...
        task = Task(id="test-123", type="compute", payload={"data": "test"})
    ...
    def test_task_with_priority(self):
        ...
        task = Task(
            id="test-123", type="compute", payload={"data": "test"}, priority=10
        )
...
class TestNode:
    ...
    def test_node_creation(self):
        ...
        node = Node(
            id="node-1", address="192.168.1.100", port=8080, capabilities=capabilities
        )
